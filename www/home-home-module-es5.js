...
var HomePage = /** @class */ (function () {
    function HomePage(splashScreen, alertController) {
    ...
    HomePage.prototype.actionButton = function () {
        var newItem = this.valueID;
        if (this.valueID == null || this.valueID == "" || isNaN(Number(this.valueID))) {
            ...
            var amountInt = Number(this.amount) + Number(this.valueID);
